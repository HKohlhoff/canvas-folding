...
Die optionale Canvas-Toolbar stellt die Canvas-Tree-Funktionen als Icon-Buttons direkt am oberen Rand bereit. Tooltips benennen jede Aktion; nicht anwendbare Aktionen sind deaktiviert. Bei knapper Breite bleibt die Leiste horizontal scrollbar. `Show canvas toolbar initially` legt nur den Startzustand fest, der anschließend über Commands oder den Ausblenden-Button geändert werden kann.
