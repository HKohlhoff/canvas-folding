...
Die Branch-Controls sind per Tastatur erreichbar: `Enter` oder `Leertaste` klappt den Zweig ein beziehungsweise aus, `Umschalt+F10` oder die Kontextmenütaste öffnet die Ebenenauswahl. Der Griff der Canvas-Toolbar lässt sich außer durch Ziehen auch mit den Pfeiltasten bewegen.
