...
- Reach branch controls in spatial order; use Enter/Space to toggle and Shift+F10, Alt+Enter or the context-menu key to open the levels menu. Verify focus remains on the invoked function.
